...
public class ViewController{
  ...
  public double[] calculateColumn(int i){
    ...
    double correctedDistance = collision[2] * Math.cos(collision[3] - vModel.getPlayer().getHeading());//Fixing fisheye effect by adjusting distance
    double wallHeight = (64 * 480) / correctedDistance;//Wall height = tileSize * screenHeight divided by the corrected distance
    ...
    return new double[]{x,wallTop,columnWidth,wallHeight};
